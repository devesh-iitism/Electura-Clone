		...
		return (
			<div>
				<div className="container">
					<h1 className="pathSuccess">The Path to Success</h1>
					<img className="pathImg" width="100%" height="773" src="https://electura.co/wp-content/uploads/2020/07/Presentation1-1-768x773.jpg" />
					<div className="row afterImage">
